        ...
        <div className="relative">
          <div className="lg:w-[45%] w-full lg:pl-8 pl-0 py-8">
            ...
            <div className="flex items-center w-full mt-6">
              <a
                href="#"
                className="border-[#D50000] border-[2px] px-8 py-3 lg:text-[18px] md:text-[18px] text-[16px] font-semibold text-[#D50000] rounded-xl transition-all duration-500 ease-in-out bg-[#0A0A0A] group-hover:bg-[#D50000] group-hover:text-[#fff]"
              >
                View Portfolio
              </a>
            </div>
