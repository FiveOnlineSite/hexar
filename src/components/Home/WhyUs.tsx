  ...
  return (
    ...
    >
      ...
      >
        {/* CARD 1 */}
        <SwiperSlide>
        <div className=" group relative bg-[#000] rounded-lg overflow-hidden xl:h-[494px] h-full transition-all duration-700 mx-5 "> <div className="overflow-hidden"> <img src="./images/why-us-2.png" className=" w-full object-cover xl:h-[420px] h-full xl:scale-110 scale-100 xl:group-hover:h-[300px] origin-center transition-all duration-700 ease-out " /> </div> <div className=" xl:absolute relative xl:-bottom-[21%] bottom-0 xl:group-hover:bottom-[5%] transition-all duration-700 ease-out py-2 pl-4 pr-8 "> <h2 className="lg:text-[32px] md:text-[25px] text-[20px] font-semibold leading-tight py-2"> Artistic Mastery </h2> <p className="lg:text-[18px] md:text-[16px] text-[14px] font-light leading-base pb-4"> Our team blends world-class artistry with deep technical expertise, delivering 3D work that is both visually stunning and production-ready. </p> </div> </div>
        </SwiperSlide>
