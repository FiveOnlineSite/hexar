...
export default function MissionVision({ id, ...rest }: MissionVisionProps) {
  return (
    <section {...rest} id={id} className="lg:py-16 md:py-16 py-8 top-0 left-0 mission-vision-section w-full h-full bg-[url('/images/mission-vision-bg.png')] bg-no-repeat xl:bg-[25%] 3xl:bg-center 2xl:bg-center xl:bg-center lg:bg-center md:bg-center bg-top bg-contain bg-[#0A0A0A]">
...
<div className="lg:w-[50%] w-full h-full flex items-center">
  ...
  <mask id="diamondMask">
    ...
    <div className="lg:w-[50%] w-full lg:pe-20 md:pe-0 md:px-16 px-8">
        <div className="pb-2">
            <h2 className="reveal lg:text-[56px] md:text-[40px] text-[36px] font-semibold leading-tight mb-5">Our Mission</h2>
        ...
        <div className="lg:pt-10 md:pt-8 pt-6">
            <h2 className="reveal lg:text-[56px] md:text-[40px] text-[36px] font-semibold leading-tight mb-5">Our Vision</h2>
