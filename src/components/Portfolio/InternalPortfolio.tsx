  ...
  slug: slugify(item.title),
    ...
    return (
        ...
        >
          ...
          {internalPortfolio.map((portfolio, i) => (
        ...
        <div className="group-hover:shadow-[0px_16px_20px_0px_#D500001A] overflow-hidden shadow-[0_4px_16px_0_#00000033] relative rounded-lg h-full transition-all duration-700 mx-2 "> 
            <div className="overflow-hidden"> 
                <img src={portfolio.img} className="w-full object-contain h-full scale-100 xl:group-hover:scale-150 origin-top transition-all duration-700 ease-out rounded-lg" /> 
            </div> 
