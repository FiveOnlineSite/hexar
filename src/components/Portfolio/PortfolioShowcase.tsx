...
export default function PortfolioShowcase(){
    return (
        <section className="portfolio-showcase-section lg:p-16 md:p-16 p-8">
            <div>
                <h2 className="3xl:text-[62px] 2xl:text-[60px] xl:text-[58px] lg:text-[58px] md:text-[52px] text-[35px] text-[#FFFFFF] leading-tight font-bold">Our Project <span className="text-[#D50000]">Showcase</span></h2>
            </div>
            <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5 lg:mt-10 mt-8">
                <div className="relative overflow-hidden group rounded-lg">
                    <img src="./images/portfolio-1.png" alt="portfolio-1" className="relative h-full w-full object-contain rounded-lg" />
                    <div className="absolute -bottom-[140%] left-0 3xl:h-[90vh] 2xl:h-[82vh] xl:h-[600px] md:h-[500px] sm:h-[500px] h-[480px] w-full bg-[#00000099] rounded-lg group-hover:bottom-0 transition-all duration-700 px-8 py-4 flex flex-col items-center justify-end">
