    ...
    return (
        <section className="footer-section bg-[#fff] lg:py-16 lg:px-20 p-8">
            <div className="grid lg:grid-cols-4 lg:items-start justify-start md:items-center md:grid-cols-2 grid-cols-1 gap-5">
                <div className="footer-logo flex flex-col items-center justify-start">
                ...
                <div className="services flex flex-col items-center justify-start">
                ...
                <div className="quick-links flex flex-col items-center justify-start">
